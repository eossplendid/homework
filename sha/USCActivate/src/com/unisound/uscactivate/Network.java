...
//	                        Log.i(TAG , "subType: "+networkInfo.getSubtypeName() +" : "+networkInfo.getTypeName());
//	                        type = judge2GOr3G(context) ? TYPE_3G : TYPE_2G;
	 ...
	 public static long getServerTimeDetal(String strServerDate){
		long rsponseTime = 0;
        if (!TextUtils.isEmpty(strServerDate)){
            ...
            try {
                ...
                rsponseTime = serverDate.getTime();
            }catch(Exception exception){
            	exception.printStackTrace();
            	LogUtil.e("getServerTime exception");
            }
        }
		return rsponseTime;
	}
